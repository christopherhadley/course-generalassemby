# Code for Naive Bayes spam classification
# lesson 4
# This is taken from Machine learning for hackers


# I can't see a stage where the data is split into test and train .... ! 
...
spam.path <- file.path("data-lesson4", "spam")
spam2.path <- file.path("data-lesson4", "spam_2")
easyham.path <- file.path("data-lesson4", "easy_ham")
easyham2.path <- file.path("data-lesson4", "easy_ham_2")
hardham.path <- file.path("data-lesson4", "hard_ham")
hardham2.path <- file.path("data-lesson4", "hard_ham_2")

# Create motivating plot - this is referenced in chapter 3 of the ML book
x <- runif(1000, 0, 40) # uniform distribution of 1,000 data points between 0 and 40
y1 <- cbind(runif(100, 0, 10), 1) # bind by columns
...
# This creates a graphic that is used in the book
# Grammar of graphics - ggplot2 website

# bog standard way of plotting in R:
plot(V2 ~ x, data = val)
# This quickly gets nasty...
# but is good for exploratory analysis of simple things - figures out what you want

# ggplot - uses a different grammar - build up the plot by adding elements successively
...
get.msg <- function(path)
{
  ...
  ### STEP THROUGH THE FOLLOWING LINE....
